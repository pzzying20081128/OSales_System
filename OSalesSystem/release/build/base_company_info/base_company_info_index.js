function create_base_company_info_window(moduleId, moduleName) {
	...
	var mainGridModule = new mainGridWindow({
		...
		url : "ssssssssss",
		// grid_column.record
		record : base_company_info_grid_column.record,
		// grid_column.column
		column : base_company_info_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function(bt) {
					base_company_info_create_windows(moduleId, moduleName, {
					grid : mainGridModule,
				...
				handler : function(bt) {
					 base_company_info_update_windows(moduleId, moduleName, {
					 grid : mainGridModule,
			...
			//	id : moduleId + '_delete',
				...
				handler : function(bt) {
					  base_company_info_delete_windows(moduleId, moduleName, {
					 grid : mainGridModule,
					 });
				}
			}, {
				...
				//keyBinding : createSearchKey(),
				handler : function() {
					var searchWindex = base_company_info_search_windows(moduleId, moduleName, {
					grid : mainGridModule,
					searchParams: base_company_info_search_params
					});
				}
			}]
	...
	var detailModule = new create_base_company_info_detail_window(moduleId + "_detail", "明细", {
		mainGrid : mainGrid
	});
	...
	window.showWin();
		...
		function   base_company_info_delete_windows(moduleId, moduleName, params) {
