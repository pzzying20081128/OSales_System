...
public class StockInvoiceAction extends OSalesSystemABAction<StockInvoice> {
    ...
    public String list() throws Exception {
        try {
            SelectPage<StockInvoice> selectPage = service.search(optType, searchBean, commSearchBean, start, limit) ;
