...
@Component("StockPaymentSearchUnits")
public class StockPaymentSearchUnits extends ABCommonsService {
    ...
    private String createWhere(Map<String, Object> value, StockPaymentSearchBean searchBean, CommSearchBean commSearchBean) {
        ...
        if (!ToolsUnits.listIsNULL(searchBean.getStatuses())) {
            sqlWhere = sqlWhere + "  and   stockPayment.status in(:statuses) " ;
            value.put("statuses", searchBean.getStatuses()) ;
        }

        if (searchBean.getStatus() != null) {
            sqlWhere = sqlWhere + "  and   stockPayment.status  = (:status) " ;
