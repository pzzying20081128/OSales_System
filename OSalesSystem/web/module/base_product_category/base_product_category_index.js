function create_base_product_category_window(moduleId, moduleName) {

	var mainGridModule = new mainGridWindow({
		moduleId : moduleId,
		// list grid
		url : "./list_ProductCategory_list.do",
		// grid_column.record
		record : base_product_category_grid_column.record,
		// grid_column.column
		column : base_product_category_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function(bt) {
					base_product_category_create_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
				...
				handler : function(bt) {
					base_product_category_delete_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
					});
				}
				...
				handler : function() {
					var searchWindex = base_product_category_search_windows(moduleId, moduleName, {
						grid : mainGridModule,
						searchParams : base_product_category_search_params
					});
				}
			}]
	...
	function base_product_category_delete_windows(moduleId, moduleName, params) {
