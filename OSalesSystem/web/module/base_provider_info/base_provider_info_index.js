function create_base_provider_info_window(moduleId, moduleName) {

	var mainGridModule = new mainGridWindow({
		moduleId : moduleId,
		// list grid
		url : "./list_ProviderInfo_list.do",
		// grid_column.record
		record : base_provider_info_grid_column.record,
		// grid_column.column
		column : base_provider_info_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function() {
					var searchWindex = base_provider_info_search_windows(moduleId, moduleName, {
						grid : mainGridModule,
						searchParams : base_provider_info_search_params
					});
				}
			}]
	...
	function base_provider_info_delete_windows(moduleId, moduleName, params) {
		...
		showMsgYN({
			...
			yes : function(YN) {
				ERPAjaxRequest({
					url : "./simple_ProviderInfo_remove.do",
					params : {
