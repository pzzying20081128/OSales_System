function produce_combined_product_detail_update_windows(moduleId, moduleName, params) {
	...
	var produce_combined_product_detail_params = {
		title : "编辑" + moduleName,
		action : "update",
		grid : grid,
		// 结果路径
	...
	var produce_combined_product_detail_create_window = new produce_combined_product_detail_save_update_form_panel_windows(produce_combined_product_detail_params);

	produce_combined_product_detail_create_window.load({
