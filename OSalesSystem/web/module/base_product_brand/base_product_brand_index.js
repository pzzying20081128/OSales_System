function create_base_product_brand_window(moduleId, moduleName) {

	var mainGridModule = new mainGridWindow({
		moduleId : moduleId,
		// list grid
		url : "./list_ProductBrand_list.do",
		// grid_column.record
		record : base_product_brand_grid_column.record,
		// grid_column.column
		column : base_product_brand_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function() {
					var searchWindex = base_product_brand_search_windows(moduleId, moduleName, {
						grid : mainGridModule,
						searchParams : base_product_brand_search_params
					});
				}
			}]
	...
	function base_product_brand_delete_windows(moduleId, moduleName, params) {
