function create_stock_contract_window(moduleId, moduleName) {
	...
	var mainGridModule = new mainGridWindow({
		moduleId : moduleId,
		// list grid
		url : "./list_StockContract_list.do",
		// grid_column.record
		record : stock_contract_grid_column.record,
		// grid_column.column
		column : stock_contract_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function(bt) {
					stock_contract_create_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
				...
				handler : function(bt) {
					stock_contract_delete_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
					});
				}
				...
				// keyBinding : createSearchKey(),
				handler : function() {
					var searchWindex = stock_contract_search_windows(moduleId, moduleName, {
						grid : mainGridModule,
						searchParams : stock_contract_search_params
					});
				}
			}]
	...
	var detailModule = new create_stock_contract_detail_window(moduleId + "_detail", "明细", {
		mainGrid : mainGrid
	});
	...
	function stock_contract_delete_windows(moduleId, moduleName, params) {
