
	      {
			...
			mapping : 'stockOrder'
            		 	      	      ...
            		 	      	      // ----------------------------------------------------------------------//
			  {
				...
				items : [{
					id : 'stockinstore.providerInfoId',
