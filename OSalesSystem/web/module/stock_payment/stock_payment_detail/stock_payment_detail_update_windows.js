function stock_payment_detail_update_windows(moduleId, moduleName, params) {
	...
	var stock_payment_detail_params = {
		title : "编辑" + moduleName,
		action : "update",
		grid : grid,
		// 结果路径
	...
	var stock_payment_detail_create_window = new stock_payment_detail_save_update_form_panel_windows(stock_payment_detail_params);
	
		stock_payment_detail_create_window.load({
