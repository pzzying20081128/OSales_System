function create_stock_payment_detail_window(moduleId, moduleName) {
	...
	var mainGridModule = new mainGridWindow({
		...
		url : "ssssssssss",
		// grid_column.record
		record : stock_payment_detail_grid_column.record,
		// grid_column.column
		column : stock_payment_detail_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function(bt) {
					stock_payment_detail_create_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
				...
				handler : function(bt) {
					stock_payment_detail_update_windows(moduleId, moduleName, {
						grid : mainGridModule,
				...
				handler : function(bt) {
					stock_payment_detail_delete_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
					});
				}
				...
				// keyBinding : createSearchKey(),
				handler : function() {
					var searchWindex = stock_payment_detail_search_windows(moduleId, moduleName, {
						grid : mainGridModule,
						searchParams : stock_payment_detail_search_params
					});
				}
			}]
	...
	function stock_payment_detail_delete_windows(moduleId, moduleName, params) {
