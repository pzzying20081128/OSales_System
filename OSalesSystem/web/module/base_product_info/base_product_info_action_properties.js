var base_product_info_grid_column = {
	record : [{
		...
		name : 'lastStockTaxPrice',
		mapping : 'lastStockTaxPrice'
	}, {
		name : 'lastStockTaxPriceMoneyShow',
		mapping : 'lastStockTaxPriceMoneyShow'
	}, {
		name : 'lastStockTaxPriceMoneyHide',
		mapping : 'lastStockTaxPriceMoneyHide'
	}, {
		name : 'lastSalesTaxPrice',
		mapping : 'lastSalesTaxPrice'
	}, {
		name : 'lastSalesTaxPriceMoneyShow',
		mapping : 'lastSalesTaxPriceMoneyShow'
	}, {
		name : 'lastSalesTaxPriceMoneyHide',
		mapping : 'lastSalesTaxPriceMoneyHide'
	}, {
		name : 'text',
		mapping : 'text'
	}, {
	...
	column : [new Ext.grid.ERPRowNumberer(), {
		...
		header : '最后含税采购价',
		width : 200,
		dataIndex : 'lastStockTaxPriceMoneyShow',
		sortable : true,
		renderer : function(value, cellmeta, record, rowIndex, columnIndex, store) {
		...
		header : '最后含税销售价',
		width : 200,
		dataIndex : 'lastSalesTaxPriceMoneyShow',
		sortable : true,
		renderer : function(value, cellmeta, record, rowIndex, columnIndex, store) {
