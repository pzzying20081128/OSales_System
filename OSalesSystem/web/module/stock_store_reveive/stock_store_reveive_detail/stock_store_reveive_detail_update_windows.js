function stock_store_reveive_detail_update_windows(moduleId, moduleName, params) {
	...
	var stock_store_reveive_detail_params = {
		title : "编辑" + moduleName,
		action : "update",
		grid : grid,
		// 结果路径
	...
	var stock_store_reveive_detail_create_window = new stock_store_reveive_detail_save_update_form_panel_windows(stock_store_reveive_detail_params);
	
		stock_store_reveive_detail_create_window.load({
