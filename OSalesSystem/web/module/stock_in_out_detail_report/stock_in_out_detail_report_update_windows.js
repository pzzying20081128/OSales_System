function stock_in_out_detail_report_update_windows(moduleId, moduleName, params) {
	...
	var stock_in_out_detail_report_params = {
		title : "编辑" + moduleName,
		action : "update",
		grid : grid,
		// 结果路径
	...
	var stock_in_out_detail_report_create_window = new stock_in_out_detail_report_save_update_form_panel_windows(stock_in_out_detail_report_params);
	
		stock_in_out_detail_report_create_window.load({
