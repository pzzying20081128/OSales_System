...
var base_info_staff_search_params = {
	...
	params : function() {
		var params = {
			...
			// 'searchBean.account' :
			// Ext.getCmp('searchBean.account').getValue(),
			//			
			// 'searchBean.isStockMan' :
			// Ext.getCmp('searchBean.isStockMan').getValue(),
			// 'searchBean.isTransportMan' :
			// Ext.getCmp('searchBean.isTransportMan').getValue(),
			// 'searchBean.isBizMan' :
			// Ext.getCmp('searchBean.isBizMan').getValue(),
			// 'searchBean.isGoodsMan' :
			// Ext.getCmp('searchBean.isGoodsMan').getValue(),
			// 'searchBean.phone' : Ext.getCmp('searchBean.phone').getValue(),
			// 'searchBean.address' :
			// Ext.getCmp('searchBean.address').getValue(),
