function store_product_info_detail_update_windows(moduleId, moduleName, params) {
	...
	var store_product_info_detail_params = {
		title : "编辑" + moduleName,
		action : "update",
		grid : grid,
		// 结果路径
	...
	var store_product_info_detail_create_window = new store_product_info_detail_save_update_form_panel_windows(store_product_info_detail_params);
	
		store_product_info_detail_create_window.load({
