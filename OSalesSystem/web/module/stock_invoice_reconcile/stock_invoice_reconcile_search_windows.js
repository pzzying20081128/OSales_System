function stock_invoice_reconcile_search_windows(moduleId, moduleName, params) {
		...
		items : [{// 第一排
			...
			items : [{
				...
				items : [createERPlocalBoxSelect({
					id : 'searchBean.reconciliations',
					name : 'searchBean.reconciliations',
					fieldLabel : '发票状态',
					defaultValue : null,
					localdata : [['已对帐', "已对帐"], ['末对帐', '末对帐'], ["全部对帐", "全部对帐"], ["删除", "删除"]],
					defaultValue : null,
					allowBlank : true
				})]
			}, // 1-1 end
