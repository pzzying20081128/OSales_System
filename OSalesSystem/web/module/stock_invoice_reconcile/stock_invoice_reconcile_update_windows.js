function stock_invoice_reconcile_update_windows(moduleId, moduleName, params) {
	...
	var stock_invoice_reconcile_params = {
		title : "编辑" + moduleName,
		action : "update",
		grid : grid,
		// 结果路径
	...
	var stock_invoice_reconcile_create_window = new stock_invoice_reconcile_save_update_form_panel_windows(stock_invoice_reconcile_params);
	
		stock_invoice_reconcile_create_window.load({
