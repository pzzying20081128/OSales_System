 ...
 * @extends Ext.tree.TreeSorter Provides sorting of nodes in a
 *          {@link Ext.ux.tree.TreeGrid}. The TreeGridSorter automatically
 *          monitors events on the associated TreeGrid that might affect the
 *          tree's sort order (beforechildrenrendered, append, insert and
...
Ext.ux.tree.TreeGridSorter = Ext.extend(Ext.tree.TreeSorter, {
	/**
	 * @cfg {Array} sortClasses The CSS classes applied to a header when it is
	 *      sorted. (defaults to <tt>['sort-asc', 'sort-desc']</tt>)
	 */
	sortClasses : ['sort-asc', 'sort-desc'],
	/**
	 * @cfg {String} sortAscText The text displayed in the 'Sort Ascending' menu
	 *      item (defaults to <tt>'Sort Ascending'</tt>)
	 */
	sortAscText : 'Sort Ascending',
	/**
	 * @cfg {String} sortDescText The text displayed in the 'Sort Descending'
	 *      menu item (defaults to <tt>'Sort Descending'</tt>)
	 */
