...
Ext.ux.tree.TreeGrid = Ext.extend(Ext.tree.TreePanel, {
	...
	syncHeaderScroll : function() {
		...
		this.innerHd.dom.scrollLeft = mb.scrollLeft; // second time for IE
														// (1/2 time first
														// fails, other browsers
														// ignore)
	},
