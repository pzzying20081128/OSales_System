/*
 * ! accounting.js v0.3.2 Copyright 2011, Joss Crowcroft
 * 
 * Freely distributable under the MIT license. Portions of accounting.js are
 * inspired or borrowed from underscore.js
 * 
...
( function(root, undefined) {
	 ...
	 * (default: "."), so if the number uses a non-standard decimal separator,
	...
	var unformat = lib.unformat = lib.parse = function(value, decimal) {
		...
		// minus sign:
		var regex = new RegExp("[^0-9-" + decimal + "]", ["g"]), unformatted = parseFloat( ( "" + value ).replace(/\((.*)\)/, "-$1") // replace
																																		// bracketed
																																		// values
																																		// with
																																		// negatives
