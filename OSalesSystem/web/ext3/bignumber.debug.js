...
with ({
	...
	o.add = function(n) {
		...
		var o = new BigNumber(this), a = o._d, b = n._d, la = o._f, lb = n._f, n = Math.max(la, lb), i, r;
	...
	o.multiply = function(n) {
		var o = new BigNumber(this), r = o._d.length >= ( n = new BigNumber(n) )._d.length, a = ( r ? o : n )._d, b = ( r ? n : o )._d, la = a.length, lb = b.length, x = new BigNumber, i, j, s;
	...
	o.divide = function(n) {
		...
		var o = new BigNumber(this), a = o._d, b = n._d, la = a.length - o._f, lb = b.length - n._f, r = new BigNumber, i = 0, j, s, l, f = 1, c = 0, e = 0;
	...
	o.pow = function(n) {
		...
		if ( ( n = ( new BigNumber(n) ).intPart() ) == 0)
			return o.set(1);
